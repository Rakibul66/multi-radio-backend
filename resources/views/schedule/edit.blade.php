                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="schedule_name" class="form-control" id="schedule_name"
                                    placeholder="Schedule Name" required="" value="{{old('schedule_name',$schedule->schedule_name)}}">
                                @error('schedule_name')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="image" type="file" id="image" accept="image/*" class="dropify" data-height="200" data-default-file="{{URL::to($schedule->image)}}" /> 
                                @error('image')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
